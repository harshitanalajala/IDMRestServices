...
public final class DocumentDataHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(TTIMPORT.DocumentDataHelper.id(), "DocumentData",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(10))));
		}
		return _type;
	}
	...
	{
		return "IDL:TTIMPORT/DocumentData:1.0";
	}
