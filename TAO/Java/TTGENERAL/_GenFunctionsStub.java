...
import TTGENERAL.GenFunctionsOperations;
...
public class _GenFunctionsStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements TTGENERAL.GenFunctions
{
	private String[] ids = {"IDL:TTGENERAL/GenFunctions:1.0","IDL:TTGENERAL/MiscFunctions:1.0","IDL:TTREPLOGGER/TTLogger:1.0"};
	@Override
	public String[] _ids()
	{
		return ids;
	...
	public final static java.lang.Class _opsClass = TTGENERAL.GenFunctionsOperations.class;
	@Override
	public void logError(java.lang.String aTicket, java.lang.String aMessage, java.lang.String aReason) throws TTEXCEPTIONS.AuthenticationException,TTEXCEPTIONS.GenericException,TTEXCEPTIONS.TTlibException
	{
		...
		else
		{
			...
			GenFunctionsOperations _localServant = (GenFunctionsOperations)_so.servant;
			try
			{
